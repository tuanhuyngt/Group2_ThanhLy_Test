...
namespace Group2_ThanhLy_Test.BaseClass
{
    public class BaseTest
    {
        ...
        {
            ele = webDriver.FindElement(By.XPath("/html/body/app-root/ng-component/div/div/div[1]/side-bar-menu/nav/div[1]/div/ul/li[3]"));
            ele.Click();
            Thread.Sleep(400);
